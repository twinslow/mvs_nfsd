...
//          DD DISP=SHR,DSN=TONYW.DINONFS.OBJLIB(TXDR)
//          DD DISP=SHR,DSN=TONYW.DINONFS.OBJLIB(TRPC)
//          DD DISP=SHR,DSN=TONYW.DINONFS.OBJLIB(TFHANDLE)
//          DD DISP=SHR,DSN=TONYW.DINONFS.OBJLIB(TMVSFID)
//          DD DISP=SHR,DSN=TONYW.DINONFS.OBJLIB(TEBCDIC)
//          DD DISP=SHR,DSN=TONYW.DINONFS.OBJLIB(TMVSUTL)
